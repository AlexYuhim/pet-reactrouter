...
export function HeroDetail({ characters }) {
  ...
  return (
    <>
      ...
      <div className="hero_card_detail_wr">
        ...
        {selectedPerson.type && (
          <div className="hero_card_type">Описание : {selectedPerson.type}</div>
        )}
        <div className="hero_card_gender"> Пол : {selectedPerson.gender} </div>
        <div className="hero_card_status">Статус : {selectedPerson.status}</div>
